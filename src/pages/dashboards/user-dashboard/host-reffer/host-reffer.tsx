...
import { HostRefferContent } from "../../../../components/dashboards/user-dashboard/host-reffer-content";
import { BreadCrumb } from "../../../../shared/ui/bread-crumb";

export const HostReffer = () => {
  const items = [
    { url: "/user-dashboard/overview", text: "Home", isCurrentPage: false },
    { url: "/user-dashboard/host-reffer", text: "Host Reffer", isCurrentPage: true },
  ];
