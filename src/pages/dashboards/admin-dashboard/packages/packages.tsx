...
import { AdminPackagesContent } from "../../../../components/dashboards/admin-dashboard/admin-packages-content/admin-packages-content";

export const Packages = () => {
  const items = [
    { url: "/admin-dashboard/admin-dashboard-overview", text: "Home", isCurrentPage: true },
    { url: "/admin-dashboard/packages", text: "Packages", isCurrentPage: true },
  ];
